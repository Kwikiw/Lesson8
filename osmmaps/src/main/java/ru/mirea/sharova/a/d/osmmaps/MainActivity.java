package ru.mirea.sharova.a.d.osmmaps;
...
import ru.mirea.sharova.a.d.osmmaps.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Торговый центр недалеко от дома, лайк за кофе",
        ...
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Мемориальный комплекс на Поклонной горе, приятно погулять вечером",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
